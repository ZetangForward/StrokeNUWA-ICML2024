...
## **Section 2**: Prediction of Stroke Order 
...
## **Section 3**: Semantic Clusters of Strokes
...
## **Section 4**: Comparison with Other Visual Representation Methods
...
## **Section 5**: Selection about Different Model Architecture
...
## **Section 6**: Finetuning with Parameter Efficient Methods
...
## **Section 7**: SVG Generation with Different Textual Prompts
